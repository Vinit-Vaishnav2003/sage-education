  ...
  return (
    <div className="student-page">
      <div className="content">
        <h1 className="heading">8TH - 12TH STUDENT OR A PARENT?</h1>
        <p>GET YOUR QUERIES ON PAGE AND NOT STUCKED IN MIND</p>
        ...
        <div className="call-to-action">
          <p>WAIT A MINUTE... IF YOU HAVE CAME THIS FAR IN THIS WEBSITE, THEN PLEASE GET YOUR PHONE OUT DIAL THIS 10-DIGITS AND CALL US ONCE (MISSED CALL WORKS) OR WHATSAPP US</p>
          <p>WE LL MORE THAN HAPPIEST TO ASSIST YOU</p>
