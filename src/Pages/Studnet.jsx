        ...
        <div className="student-listt">
          <ul className="student-features-list">
            ...
            <ul>
              ...
              <li>Provide primary, secondary, and backup career plans <span onClick={toggleKnowMore} style={{  color: 'blue', padding: '2px 10px', border: 'none', borderRadius: '10px', cursor: 'pointer',backgroundColor:"white" }}>Know More →</span>  </li>
            </ul>
