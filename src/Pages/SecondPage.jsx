  ...
  return (
    <div className="second-page-container">
      <div className="second-page-content" >
        ...
        <p>So, if student is in 10th, then we make Personalised - Psychometric Career Reports for them !!!! <a className="second-page-a" href="#">PDF DOWNLOAD</a></p>
        <p>So, if student is in 11th-12th, then we make Personalised Career Maps for them !!!! <a className="second-page-a" href="#">PDF DOWNLOAD</a></p>
        <p>So, if student is in 8th-9th, then we introduce them to the process of introspective thinking and career inquisitiveness !!!! <a className="second-page-a" href="#">PDF DOWNLOAD</a></p>
