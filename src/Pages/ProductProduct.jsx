  ...
  const images = [
    {
      ...
      backContent: [
        ...
        'Top college and exam recommendations',
        'Concept of primary, secondary, and backup plans',
        'Strategic career planning',
        'Personal counseling and doubt-solving assistance'
      ]
    },
    {
      url: product2,
      ...
      backContent: [
        ...
        'Personalized information about colleges and exams',
    ...
    },
    {
      ...
      backContent: [
        'Specially for 8th-9th Class Students',
