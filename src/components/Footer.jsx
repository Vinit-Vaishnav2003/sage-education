                ...
                <div className="footer-content">
                    ...
                    <div className='footertext'>
                        ...
                        <div className="footer-contact">
                            ...
                            <p> 1st Floor, Navre Arcade, Shop no 6 & 7, C- Wing, <br />  Shivaji Chowk, Ambernath East, Ambernath, <br />Maharashtra 421501</p>
                        </div>
                    </div></div>
                <div className="footer-bottom">
                    <p style={{ marginBottom: '0px' }}> © All Copyright Sole Proprietorship - Gaurav Chotaliya </p>
                    <p>Udyam No. - UDYAM-MH-33-0543565</p> 
                </div>
            </footer>
        </div>
    );
