      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className={`nav-link ${activeLink === 'institute' ? 'active' : ''}`} onClick={() => handleNavigation('institute')}>Institute Owner</a>
            </li>
            <li className="nav-item">
              <a className={`nav-link ${activeLink === 'student' ? 'active' : ''}`} onClick={() => handleNavigation('student')}>I'm Student</a>
            </li>
            <li className="nav-item">
